...
updated: '2026-01-27'
source: redhat
source_url: https://www.redhat.com/en/blog/the-anatomy-of-automation-execution-environments
description: Red Hat Ansible Automation Platform 2 introduced  major architectural
  changes, like automation mesh and automation execution environments, that help extend
  Ansible automation across your organization in a flexible manner, providing a single
  solution to all your organizational and hybrid cloud automation needs.
topics: []
read_time_minutes: 7
...
There will be instances where the configuration in the automation execution environment specification isn't reflected or errors occur when you're building the automation execution environment. In these instances, it's important to understand the role for the EE\_BUILDER\_IMAGE. The next section explains this in more detail.

## Automation execution environment design

[![Automation execution environment diagram.](https://www.redhat.com/rhdc/managed-files/execution-environment-diagram.png)](https://www.redhat.com/rhdc/managed-files/execution-environment-diagram.png)
