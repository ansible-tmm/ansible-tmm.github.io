...
slug: empower-everyone-automate-ansibles-self-service-automation-portal
authors:
- slug: hicham-mourad
  name: Hicham Mourad
...
updated: '2025-11-25'
source: redhat
source_url: https://www.redhat.com/en/blog/empower-everyone-automate-ansibles-self-service-automation-portal
description: Discover how the new self-service automation portal in Ansible Automation
  Platform 2.6 simplifies automation for all users, enabling the core team to build
  value and empowering SMEs to apply it in their daily tasks. Increase consistency,
  control over automation, and autonomy for teams across the organization.
topics:
...
- Learn more about [Ansible Automation Platform](https://www.redhat.com/en/technologies/management/ansible) and self-service automation.
