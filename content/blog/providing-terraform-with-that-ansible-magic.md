...
slug: providing-terraform-with-that-ansible-magic
authors:
- slug: nuno-martins
  name: Nuno Martins
...
updated: '2026-01-27'
source: redhat
source_url: https://www.redhat.com/en/blog/providing-terraform-with-that-ansible-magic
description: 'We are adding more value to infrastructure as code with an addition
  to the Ansible Certified Content Collection: The Ansible provider for Terraform.'
topics: []
read_time_minutes: 4
