(function () {
  ...
  const SOCIAL_ICONS = {
    ...
    redhat:
      '<svg class="icon icon--sm" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">' +
      '<path fill="currentColor" d="M12 2.5c-4.8 0-8.7 2.9-8.7 6.5v1.2c0 .6.5 1.1 1.1 1.1h15.2c.6 0 1.1-.5 1.1-1.1V9c0-3.6-3.9-6.5-8.7-6.5zm-7.6 9.3v1.4c0 3.8 3.4 7 7.6 7s7.6-3.2 7.6-7v-1.4H4.4z"/>' +
      '</svg>',
  };
